...
public class Transition_2 {
	 ...
	 */
	public Transition_2(JFrame frame) {
		contFlag = false;
		initialize(frame);
	}
	...
	private void initialize(JFrame frame) {
		...
		lblNewLabel_1 = new JLabel("our hero teams up with another hero");
		lblNewLabel_1.setFont(new Font("OCR A Extended", Font.PLAIN, 18));
		lblNewLabel_1.setBounds(86, 11, 438, 65);
		panel_1.add(lblNewLabel_1);
		
		lblNewLabel_1_1 = new JLabel("that had escaped. They now escape into a nearby");
		lblNewLabel_1_1.setFont(new Font("OCR A Extended", Font.PLAIN, 18));
		lblNewLabel_1_1.setBounds(37, 67, 586, 65);
		panel_1.add(lblNewLabel_1_1);
		
		lblNewLabel_1_1_1 = new JLabel("village where they are beset by a group");
		lblNewLabel_1_1_1.setFont(new Font("OCR A Extended", Font.PLAIN, 18));
