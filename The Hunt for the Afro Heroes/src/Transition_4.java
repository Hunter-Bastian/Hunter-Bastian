...
public class Transition_4 {
	 ...
	 */
	public Transition_4(JFrame frame) {
		contFlag = false;
		initialize(frame);
	}
	...
	private void initialize(JFrame frame) {
		...
		lblNewLabel = new JLabel("Following their victory,");
		lblNewLabel.setFont(new Font("OCR A Extended", Font.PLAIN, 22));
		lblNewLabel.setBounds(86, 11, 438, 65);
		panel.add(lblNewLabel);
		lblNewLabel.setVisible(true);
		
		lblWithTheirDoor = new JLabel("a member of the resistance");
