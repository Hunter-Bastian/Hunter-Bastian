...
public class Transition_3 {
	 ...
	 */
	public Transition_3(JFrame frame) {
		contFlag = false;
		initialize(frame);
	}
	...
	private void initialize(JFrame frame) {
		...
		lblNewLabel = new JLabel("Our hero’s victory over the bounty hunters");
		lblNewLabel.setFont(new Font("OCR A Extended", Font.PLAIN, 22));
		lblNewLabel.setBounds(86, 11, 438, 65);
		panel.add(lblNewLabel);
		lblNewLabel.setVisible(true);
		
		lblWithTheirDoor = new JLabel("was rewarded at the tavern,");
