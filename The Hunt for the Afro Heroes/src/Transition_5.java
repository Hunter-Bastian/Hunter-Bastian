...
public class Transition_5 {
	 ...
	 */
	public Transition_5(JFrame frame) {
		contFlag = false;
		initialize(frame);
	}
	...
	private void initialize(JFrame frame) {
		...
		lblNewLabel = new JLabel("The Afro Heroes approach");
		lblNewLabel.setFont(new Font("OCR A Extended", Font.PLAIN, 22));
		lblNewLabel.setBounds(86, 11, 438, 65);
		panel.add(lblNewLabel);
		lblNewLabel.setVisible(true);
		
		lblWithTheirDoor = new JLabel("King Froseidon’s throne room");
		...
		lblNewLabel_1 = new JLabel("with trepidation as they");
		lblNewLabel_1.setFont(new Font("OCR A Extended", Font.PLAIN, 22));
		lblNewLabel_1.setBounds(86, 11, 438, 65);
		panel_1.add(lblNewLabel_1);
		
		lblNewLabel_1_1 = new JLabel("feel his presence before the final battle.");
		...
		lblNewLabel_2 = new JLabel("Caerus protect us all…");
